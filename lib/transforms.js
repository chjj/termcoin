...
transforms.addr.bcoinToInfo = function(addr) {
  ...
  // XXX Possibly use:
  //addrn.total_received = coined.utils.ntoBTC(addr.total_received);
  //addrn.total_sent = coined.utils.ntoBTC(addr.total_sent);
  //addrn.final_balance = coined.utils.ntoBTC(addr.final_balance);
