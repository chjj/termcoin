...
ui.start = function(stats, callback) {
  ...
  tabs.addresses._.list = blessed.listtable({
  ...
  tabs.transactions._.list = blessed.listtable({
  ...
  function refresh(callback, showLoad) {
    ...
    return bitcoin.getStats(function(err, stats_) {
      ...
      tabs.addresses._.list.setData(items);
      ...
      if (items.length === 1) {
        ...
        tabs.transactions._.list.__align = 'left';
      } else {
        tabs.transactions._.list.__align = 'center';
      }

      tabs.transactions._.list.setData(items);
