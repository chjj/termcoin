...
blockchain._formatTX = function(tx, block, cols) {
  ...
  if (!block || !block.hash || !+block.hash) {
    ...
    if (index.hashes[tx.block_height]) {
      block = {
        hash: coined.utils.revHex(index.hashes[tx.block_height]),
...
blockchain._transformAddr = function(addr) {
  var self = this;
...
blockchain._transformTX = function(tx, block) {
  var self = this;
  var coin = termcoin.bitcoin.coin;
...
blockchain._transformBlock = function(block) {
  var self = this;
  var coin = termcoin.bitcoin.coin;
...
blockchain._bcoinAddrToBlockchain = function(addr) {
  var self = this;
  var coin = termcoin.bitcoin.coin;
  return addr;
};

blockchain._bcoinTxToBlockchain = function(tx, block) {
  var self = this;
  var coin = termcoin.bitcoin.coin;
  return tx;
};

blockchain._bcoinBlockToBlockchain = function(block) {
  var self = this;
  var coin = termcoin.bitcoin.coin;
  return block;
};
